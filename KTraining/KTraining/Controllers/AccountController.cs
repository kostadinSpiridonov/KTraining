    ...
    public class AccountController : BaseController
    {
                ...
                default:
                    {
                       ...
                       if (user == null)
                       {
                           ...
                           ModelState.AddModelError("", Common.NoEmailExist);
                       }
                       else
                       {
                           ModelState.AddModelError("", Common.WrongPass);
                       }
                        return View(model);
                    }
            }
        ...
        public ActionResult Register()
        {
            return View(new RegisterViewModel
            {
                ...
                Roles = new SelectList(new List<string>(){Common.Student,Common.Leader})
            });
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            model.Roles = new SelectList(new List<string>() { Common.Student, Common.Leader });
            return View(model);
        }
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                // Send an email with this link
                 ...
                 await UserManager.SendEmailAsync(user.Id, "Reset Password", Common.ChangeYourPassHere+ callbackUrl);
